...
class CameraGalleryPics extends StatefulWidget {
  const CameraGalleryPics({super.key});

  @override
  State<CameraGalleryPics> createState() => _ImagePickerState();
}

class _ImagePickerState extends State<CameraGalleryPics> {
  File? _image;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
          child: Column(
        children: [
          SizedBox(height: 40),_image!=null? Image.file(_image!,width: 250,height: 250,fit: BoxFit.cover,):
          Image.network(
